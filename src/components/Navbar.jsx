...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 text-indigo">
      <div className="bg-white p-3 shadow-lg">
          <div className="flex justify-between">
            <div className="flex items-center">
              <img src="/public/logo.png" alt="Logo" className="w-[75px]" />
              <h1 className="text-2xl font-bold text-indigo-500">CONHUB</h1>
            </div>

            <div className="">
              {isLoggedIn ? (
                <span className="flex gap-3 text-lg text-indigo-500">
              ...
              <div className="flex items-center justify-center space-x-3 mb-3">
                {isLoggedIn ? (
                  <>
                    <NavLink
                      to="/profile"
                      className="hover:text-indigo-900 text-lg"
                    >
                      <svg
                        className="w-6 h-6"
                        aria-hidden="true"
                    ...
                    <button className="hover:text-indigo-900 text-lg">
                  ...
                  <NavLink to="/login" className="hover:text-indigo-900 text-lg ">
                    <button className="bg-indigo-500 hover:bg-indigo-600 p-2 mb-3 rounded-md text-white">
                      เข้าสู่ระบบ
                    </button>
                  </NavLink>
                )}
      ...
      <nav>
        <ul className="navb flex gap-10 justify-center bg-indigo-500 ">
          <li>
