...
const Profile = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-r from-slate-900 to-slate-800 py-10">
        ...
        {data && data.user ? (
          <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
            <div className="flex items-center justify-center mb-6">
              <img
                src={userInfo.pictureUrl || "/path/to/default-image.jpg"} // ใช้ภาพเริ่มต้นหากไม่มี
                alt="Profile"
            ...
            {isEditing ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-lg text-gray-600"><strong>อีเมล:</strong></label>
                  <input
                    type="email"
                    name="email"
