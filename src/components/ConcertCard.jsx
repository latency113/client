...
const ConcertCard = (props) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md cursor-pointer hover:shadow-lg w-full max-w-[420px] mx-auto flex flex-col">
      {/* Image Section */}
      ...
      {/* View Details Button - นอกการ์ด */}
      <div className="p-4">
        <NavLink
          to={`/concert/${props.id}`}
          className="flex justify-center w-full text-blue-500 py-2 px-4 text-center gap-1 border-transparent hover:border-blue-500 hover:border-b-2 hover:pb-[5px] rounded-lg transition-all duration-200"
        >
          ดูรายละเอียด
        </NavLink>
      </div>
